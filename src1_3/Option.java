...
public class Option {
    ...
    static HashMap<Integer,User> us = new HashMap<>();
    ...
    static boolean id_haveregistered(String id) {
        ...
        return us.get(number * 10 + job) != null;
    }
    ...
    static boolean pwd_wrong(int job, int id, String pwd) {
        return !us.get(id * 10 + job).getPwd().equals(pwd);
    }
    ...
    static void userRegister(String id, String name, String surname, String email, String pwd, String confirm_pwd) {
        ...
        if (user_online!=null)
            ...
            user1.setPwd(pwd);
            us.put(user1.getNumber() * 10 + user1.getJob(), user1);
    ...
    static void userLogin(String id,String pwd) {
        ...
        if(user_online!=null)
            ...
            user_online = us.get(number * 10 + job);
    ...
    static void printInfo(String id) {
        ...
        else
        {
            ...
            User user_print = us.get(print_number*10+print_job);
